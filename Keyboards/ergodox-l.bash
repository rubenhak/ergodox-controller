...
BaseMap="scancode_map leftHand ruben/left-base slave1 rightHand ruben/right-base"

# This is the default layer of the keyboard
# NOTE: To combine kll files into a single layout, separate them by spaces
# e.g.  DefaultMap="mylayout mylayoutmod"
DefaultMap="infinity_ergodox/all-leds ruben/mapping ruben/mac" # infinity_ergodox/lcdFuncMap 
