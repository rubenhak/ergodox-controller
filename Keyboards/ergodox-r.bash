...
DefaultMap="infinity_ergodox/all-leds infinity_ergodox/lcdFuncMap ruben/mapper" #  infinity_ergodox/mdergo1Overlay
...
PartialMaps[1]="infinity_ergodox/iced_func ruben/func_mapper"
